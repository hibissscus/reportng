...
<table class="titleTable">
    <tbody>
    <tr>
        <td class="h1">testee-e2e</td>
        <td id="meta">
            Info: <a href="https://github.com/hibissscus/testee" target="_top">testee</a> generated by <a href="https://testng.org/" target="_top">TestNG</a> with <a
                href="https://github.com/hibissscus/reportng" target="_top">ReportNG</a> 1.4.1
            at 20:32 CEST on Tuesday 28 September 2021
            <br><span
                id="systemInfo">sstepanov@ysura.local&nbsp;/&nbsp;Java 1.8.0_241 (Oracle Corporation)&nbsp;/&nbsp;Mac OS X 10.15.7 (x86_64)</span>
        </td>
    </tr>
    </tbody>
</table>
<table class="progressTable" border="0" cellspacing="0" cellpadding="0" style="width:100.00%;">
    <tbody>
    <tr class="progressLine" style="height: 3px">
        <td class="progressLine" style="width:0%;background-color:#999999;"></td>
        <td class="progressLine" style="width:33.33%;background-color:#44aa44;"></td>
        <td class="progressLine" style="width:33.33%;background-color:#ffaa00;"></td>
        <td class="progressLine" style="width:33.33%;background-color:#ff4444;"></td>
    </tr>
    </tbody>
</table>
<table class="overviewTable">
    ...
    <tr class="columnHeadings">
        <th><a href="suite1_groups.html">Default Suite</a></th>
        <th>Duration</th>
        <th>Passed</th>
        <th>Skipped</th>
        <th>Failed</th>
    ...
    <tr class="test">
        <td class="test">
            <a href="suite1_test1_results.html">Gradle test</a>
        </td>
        <td class="duration">
            0
        </td>
    ...
    <tr class="suite">
        ...
        <td class="duration"><span class="number">00:00:00</span></td>
        <td class="passed"><span class="number">1</span></td>
        <td class="skipped"><span class="number">1</span></td>
        <td class="failed"><span class="number">1</span></td>
        <td class="passRate">
