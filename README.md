`ReportNG` provides colour-coded `TestNG` results  [![test](https://github.com/hibissscus/reportng/actions/workflows/test.yml/badge.svg)](https://github.com/hibissscus/reportng/actions/workflows/test.yml)
=================================
