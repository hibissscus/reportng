...
public class ReportNGUtils {
     ...
     */
    public List<String> getScreenshots(ITestResult result) throws IOException {
        String outputDirectory = result.getTestContext().getOutputDirectory();
        String className = result.getTestClass().getName();
        String testName = result.getMethod().getMethodName();

        List<String> list = new ArrayList();
        final String screenshotPath = pathToScreenshot(outputDirectory, className, testName);
     ...
     * Path to screenshot.
     */
    public String pathToScreenshot(String outputDirectory, String className, String testName) {
