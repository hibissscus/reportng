...
public final class ReportMetadata {
    static final String PROPERTY_KEY_PREFIX = "testee.it.reportng.";
    static final String SLACK = PROPERTY_KEY_PREFIX + "slack";
    static final String SLACK_TOKEN = SLACK + ".token";
    static final String SLACK_CHANEL = SLACK + ".chanel";
    ...
    /**
     * Check if it is allowed to send Slack notification.
     */
    public boolean allowSlackNotification() {
        return System.getProperty(SLACK, "false").equalsIgnoreCase("true");
    }
    ...
    public String getSlackChanel() {
        return System.getProperty(SLACK_CHANEL);
    }
