...
//=============================================================================
package e2e.tips.reportng.sample;
...
public class PartiallySuccessfulTests {
    @Test
    public void test() {
        assert true;
    }
    ...
    @Test
    public void testNotSuccessfulWithOutput() {
        Reporter.log("Here is some output from a non-successful test.");
        assert false;
    }
