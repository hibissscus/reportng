...
public class HTMLReporter extends AbstractReporter {
    ...
    private static final String ONLY_FAILURES_PROPERTY = "e2e.tips.reportng.failures-only";

    private static final String TEMPLATES_PATH = "e2e/tips/reportng/templates/html/";
    ...
    private static Map<String, ISuiteResult> sortByValue(Map<String, ISuiteResult> unsortMap) {
        ...
        Collections.sort(list, new Comparator<Map.Entry<String, ISuiteResult>>() {
